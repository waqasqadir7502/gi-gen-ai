...
const config = {
  ...
  tagline: 'A comprehensive educational resource for learning Physical AI and Humanoid Robotics',
        ...
        links: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                to: '/docs/modules/module-2/intro',
              },
              {
                label: 'Module 3: Control and Intelligence',
                to: '/docs/modules/module-3/intro',
              },
              {
                label: 'Module 4: Applications and Integration',
                to: '/docs/modules/module-4/intro',
              },
            ],
          },
          {
